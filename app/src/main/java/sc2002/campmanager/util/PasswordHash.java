...
/**
 * PasswordHash class to hash passwords
 */
public class PasswordHash
{
    ...
    public static String createHash(String pw)
    {
        ...
        try {
            hash = pbkdf2(password, salt, PBKDF2_ITERATIONS, HASH_BYTES);
...
//     */
     ...
     * @param pw the hash of the valid password
     * @return true if the password is correct, false if not
     */
    public static boolean verifyPassword(String input, String pw)
    {
        // convert pw
        char[] password = input.toCharArray();

        // Decode the hash into its parameters
        String[] params = pw.split(":");
     ...
     * @return  the processed int if valid, -1 if not valid
     */
